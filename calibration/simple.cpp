...
int main( int argc, char** argv )
{
    ...
    calibration_error=calibrateCamera(object_points, image_points, image.size(), intrinsic, distCoeffs, rvecs, tvecs);
    ...
    for(i1=0; i1<successes; )
    std::cout << intrinsic << endl;
    std::cout << "Square error: " << error << endl;
    std::cout << "Error given by the calibration process: " << calibration_error << endl;
    return 0;
}
void readimageadresses(){
